  ...
  en: {
    ...
    portfolio: {
      ...
      projects: [
        ...
        { title: "Iron Beard - Premium Beard Oil Line", brief: "New beard oil line designed for maximum shelf standout and strong brand character. Cohesive, refined design, distinct scent variants, and storytelling that sells. Result: a product that looks premium and builds instant desire.", images: ["https://picsum.photos/seed/smartwatch/800/600"] },
        { title: "Lumina Cosmetics", brief: "E-commerce banner system and A+ content for a luxury skincare line. Focused on clean, glowing aesthetics.", images: ["https://picsum.photos/seed/cosmetics/800/600"] },
        { title: "Aero Headphones", brief: "High-impact social media creatives and product renders highlighting noise-cancellation features.", images: ["https://picsum.photos/seed/headphones/800/600"] }
      ]
    },
    hero: {
